    ...
    <section className='bg-white pt-[37px]  w-full'>
      <div className=' pt-[37px] lg:pt-[67px] px-0 lg:px-10 xl:px-20 2xl:container 2xl:mx-auto'>
        <div className='flex flex-col items-center justify-center lg:items-start lg:justify-start'>
          ...
          <div className='mt-[15px] max-w-[300px] nwsm:max-w-[350px] gsm:max-w-[495px]'>
          ...
          <div className='flex flex-col items-center justify-center lg:items-start lg:justify-start w-[300px] nwsm:w-[380px] lg:w-[300px] xl:w-[380px]'>
            <div className='flex flex-col items-center justify-center lg:items-start lg:justify-start gap-[15px] pt-[30px] lg:pt-[50px] pl-0 lg:pl-[30px]'>
              ...
              <div className='flex flex-col  items-center justify-center lg:items-start lg:justify-start'>
                ...
                <p className='text-black text-lg font-poppins max-w-[300px] hsm:max-w-[350px] nwsm:max-w-[375px] gsm:max-[450px] sm:max-w-max text-center lg:text-start lg:max-w-[299px] pt-[15px]'>
