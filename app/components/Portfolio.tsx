...
const Portfolio = () => {
  return (
    <section className='bg-white pt-[37px] w-full'>
      <div className=' pt-[37px] lg:pt-[67px] px-0 lg:px-10 xl:px-20 2xl:container 2xl:mx-auto'>
        <div className='flex flex-col items-center justify-center lg:items-start lg:justify-start'>
          <p className='text-[#20B15A] font-poppins font-medium text-[20px]'>
            OUR PORTFOLIO
          </p>
          <div className='mt-[15px] max-w-[300px] hsm:max-w-[350px] nwsm:max-w-[375px] gsm:max-w-[495px]'>
        ...
        <div className='mt-[4rem] flex flex-col xl:flex-row gap-[30px] xl:gap-[95px] items-center justify-center xl:justify-between 2xl:justify-between'>
          <div className='flex flex-col gap-[42.79px] items-center justify-center xl:items-start xl:justify-start'>
            ...
            <div className='flex flex-col gap-[14.26px]  items-center justify-center xl:items-start xl:justify-start'>
              ...
              <p className='text-black text-center xl:text-start max-w-[300px] hsm:max-w-[350px] nwsm:max-w-[370px] gsm:max-w-[450px] sm:max-w-[550px] text-[15.21px] font-poppins'>
          ...
          <div className='flex flex-col gap-[42.79px]  items-center justify-center xl:items-start xl:justify-start'>
            ...
            <div className='flex flex-col gap-[14.26px] items-center justify-center xl:items-start xl:justify-start'>
              ...
              <p className='text-black max-w-[300px] hsm:max-w-[350px] nwsm:max-w-[370px] gsm:max-w-[450px] sm:max-w-[533.43px] text-[15.21px] font-poppins text-center xl:text-start'>
                This is a website for a client who want to achieve their goals
                and meet their users needs while also increasing their reach.
                Accross all platforms. This is a website rebrand
              </p>
        ...
        {/* second row */}
        <div className='mt-[4rem] xl:mt-0 flex flex-col xl:flex-row gap-[30px] xl:gap-[95px] items-center justify-center xl:justify-between 2xl:justify-between'>
          <div className='flex flex-col gap-[42.79px]  items-center justify-center xl:items-start xl:justify-start'>
            ...
            <div className='flex flex-col gap-[14.26px] items-center justify-center xl:items-start xl:justify-start'>
              ...
              <p className='text-black max-w-[300px] hsm:max-w-[350px] nwsm:max-w-[370px] gsm:max-w-[450px] sm:max-w-[533.43px] text-[15.21px] text-center xl:text-start font-poppins'>
                This is a website for a client who want to achieve their goals
                and meet their users needs while also increasing their reach.
                Accross all platforms. This is a website rebrand
              </p>
